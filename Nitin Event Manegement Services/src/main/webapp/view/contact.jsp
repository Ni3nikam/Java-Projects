                    ...
                    <div class="bg-light rounded h-100 p-5">
                        ...
                        <div class="d-flex align-items-center mb-2">
                            ...
                            <div class="text-start">
                                ...
                                <span>123 Street, Karve Nager, Pune</span>
                           </div>
                        </div>
                        <div class="d-flex align-items-center mb-2">
                            ...
                            <div class="text-start">
                                ...
                                <span>Nitinnikam@gmail.com</span>
                            </div>
                        </div>
                ...
                <div class="col-xl-4 col-lg-6 wow slideInUp" data-wow-delay="0.3s">
                    <form action="contact" method="post">
                        <div class="row g-3">
                            ...
                            <div class="col-12">
                                <input type="number" class="form-control border-0 bg-light px-4" name="mobile" placeholder="Your Mobile" style="height: 55px;">
                            </div>
                            <div class="col-12">
