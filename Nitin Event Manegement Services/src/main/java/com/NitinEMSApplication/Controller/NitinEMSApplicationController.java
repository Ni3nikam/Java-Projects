package com.NitinEMSApplication.Controller;
...
import com.NitinEMSApplication.Model.Appointment;
import com.NitinEMSApplication.Model.Contact;
import com.NitinEMSApplication.Model.Login;

@Controller
public class NitinEMSApplicationController {
	...
	@RequestMapping("/nitinnikamCreateAccount")
	public String nitinnikamCreateAccount() {
		return "nitinnikam";
	}

	@RequestMapping("/nitinnikam")
	public Login  nitinnikam (Login login) {
	...
	@RequestMapping("/nitineventphotos")
